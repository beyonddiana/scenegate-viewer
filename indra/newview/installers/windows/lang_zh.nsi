...
LangString CloseSecondLifeInstDP ${LANG_TRADCHINESE} "等待 SceneGate 停止運行…"
LangString CloseSecondLifeInstMB ${LANG_TRADCHINESE} "如果 SceneGate 仍在運行，將無法進行安裝。$\n$\n請結束您在 SceneGate 內的活動，然後選擇確定，將 SceneGate 關閉，以繼續安裝。$\n選擇「取消」，取消安裝。"

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_TRADCHINESE} "等待 SceneGate 停止運行…"
LangString CloseSecondLifeUnInstMB ${LANG_TRADCHINESE} "如果 SceneGate 仍在運行，將無法進行卸載。$\n$\n請結束您在 SceneGate 內的活動，然後選擇確定，將 SceneGate 關閉，以繼續卸載。$\n選擇「取消」，取消卸載。"
