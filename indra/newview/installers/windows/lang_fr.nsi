...
LangString CloseSecondLifeInstDP ${LANG_FRENCH} "En attente de la fermeture de SceneGate..."
LangString CloseSecondLifeInstMB ${LANG_FRENCH} "SceneGate ne peut pas être installé si l'application est déjà lancée..$\n$\nFinissez ce que vous faites puis sélectionnez OK pour fermer SceneGate et continuer.$\nSélectionnez ANNULER pour annuler l'installation."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_FRENCH} "En attente de la fermeture de SceneGate..."
LangString CloseSecondLifeUnInstMB ${LANG_FRENCH} "SceneGate ne peut pas être désinstallé si l'application est déjà lancée.$\n$\nFinissez ce que vous faites puis sélectionnez OK pour fermer SceneGate et continuer.$\nSélectionnez ANNULER pour annuler la désinstallation."
