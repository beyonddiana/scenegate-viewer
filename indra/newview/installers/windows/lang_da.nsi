...
LangString CloseSecondLifeInstDP ${LANG_DANISH} "Venter på at SceneGate skal lukke ned..."
LangString CloseSecondLifeInstMB ${LANG_DANISH} "SceneGate kan ikke installeres mens programmet kører.$\n$\nAfslut programmet for at fortsætte.$\nVælg ANNULÉR for at afbryde installation."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_DANISH} "Venter på at SceneGate skal lukke ned..."
LangString CloseSecondLifeUnInstMB ${LANG_DANISH} "SceneGate kan ikke afinstalleres mens programmet kører.$\n$\nAfslut programmet for at fortsætte.$\nVælg ANNULÉR for at afbryde installation."
