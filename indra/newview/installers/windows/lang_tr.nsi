...
LangString CloseSecondLifeInstDP ${LANG_TURKISH} "SceneGate'ın kapatılması bekleniyor..."
LangString CloseSecondLifeInstMB ${LANG_TURKISH} "SceneGate zaten çalışırken kapatılamaz.$\n$\nYaptığınız işi bitirdikten sonra SceneGate'ı kapatmak ve devam etmek için Tamam seçimini yapın.$\nYüklemeyi iptal etmek için İPTAL seçimini yapın."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_TURKISH} "SceneGate'ın kapatılması bekleniyor..."
LangString CloseSecondLifeUnInstMB ${LANG_TURKISH} "SceneGate zaten çalışırken kaldırılamaz.$\n$\nYaptığınız işi bitirdikten sonra SceneGate'ı kapatmak ve devam etmek için Tamam seçimini yapın.$\nİptal etmek için İPTAL seçimini yapın."
