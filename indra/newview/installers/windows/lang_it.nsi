...
LangString CloseSecondLifeInstDP ${LANG_ITALIAN} "In attesa che SceneGate chiuda…"
LangString CloseSecondLifeInstMB ${LANG_ITALIAN} "Non è possibile installare SceneGate se è già in funzione..$\n$\nTermina le operazioni in corso e scegli OK per chiudere SceneGate e continuare.$\nScegli CANCELLA per annullare l’installazione."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_ITALIAN} "In attesa della chiusura di SceneGate…"
LangString CloseSecondLifeUnInstMB ${LANG_ITALIAN} "Non è possibile installare SceneGate se è già in funzione.$\n$\nTermina le operazioni in corso e scegli OK per chiudere SceneGate e continuare.$\nScegli CANCELLA per annullare."
