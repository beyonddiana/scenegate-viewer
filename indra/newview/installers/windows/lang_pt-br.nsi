...
LangString CloseSecondLifeInstDP ${LANG_PORTUGUESEBR} "Esperando o encerramento do SceneGate..."
LangString CloseSecondLifeInstMB ${LANG_PORTUGUESEBR} "O SceneGate não pode ser instalado enquanto ainda está sendo executado.$\n$\nTermine o que estava fazendo e selecione OK para fechar o SceneGate e continuar.$\nSelecione CANCELAR para cancelar a instalação."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_PORTUGUESEBR} "Esperando o encerramento do SceneGate..."
LangString CloseSecondLifeUnInstMB ${LANG_PORTUGUESEBR} "O SceneGate não pode ser desinstalado enquanto ainda está sendo executado.$\n$\nTermine o que estava fazendo e selecione OK para fechar o SceneGate e continuar.$\nSelecione CANCELAR para cancelar."
