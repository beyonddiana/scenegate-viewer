...
LangString CloseSecondLifeInstDP ${LANG_POLISH} "Oczekiwanie na zamknięcie SceneGate..."
LangString CloseSecondLifeInstMB ${LANG_POLISH} "SceneGate nie może zostać zainstalowane, ponieważ jest już włączone.$\n$\nZakończ swoje działania i wybierz OK aby zamknąć SceneGate i kontynuować.$\nWybierz CANCEL aby anulować instalację."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_POLISH} "Oczekiwanie na zamknięcie SceneGate..."
LangString CloseSecondLifeUnInstMB ${LANG_POLISH} "SceneGate nie może zostać zainstalowane, ponieważ jest już włączone.$\n$\nZakończ swoje działania i wybierz OK aby zamknąć SceneGate i kontynuować.$\nWybierz CANCEL aby anulować."
