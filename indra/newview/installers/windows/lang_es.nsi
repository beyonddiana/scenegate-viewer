...
LangString CloseSecondLifeInstDP ${LANG_SPANISH} "Esperando que SceneGate se cierre..."
LangString CloseSecondLifeInstMB ${LANG_SPANISH} "SceneGate no se puede instalar mientras esté en ejecución.$\n$\nTermine lo que esté haciendo y seleccione Aceptar (OK) para cerrar SceneGate y continuar el proceso.$\nSeleccione Cancelar (CANCEL) para cancelar la instalación."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_SPANISH} "Esperando que SceneGate se cierre..."
LangString CloseSecondLifeUnInstMB ${LANG_SPANISH} "SceneGate no se puede desinstalar mientras esté en ejecución.$\n$\nTermine lo que esté haciendo y seleccione Aceptar (OK) para cerrar SceneGate y continuar el proceso.$\nSeleccione Cancelar (CANCEL) para cancelar la desinstalación."
