...
void LLCrashLogger::gatherFiles()
{
	...
	else
	{
		...
		mFileMap["SecondLifeLog"] = gDirUtilp->getExpandedFilename(LL_PATH_DUMP,"SceneGate.log");
    ...
    {
        mFileMap["SecondLifeLog"] = gDirUtilp->getExpandedFilename(LL_PATH_LOGS,"SceneGate.old");
    }
